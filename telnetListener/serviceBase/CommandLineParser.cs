...
namespace lawsoncs.htg.sdtd.AdminServer
{
    ...
    public sealed class Parser
    {
        ...
        private struct COORD
        {
            ...
            internal COORD(Int16 x, Int16 y)
            {
                this.x = x;
                this.y = y;
            }
        ...
        private struct SMALL_RECT
        {
            ...
            internal SMALL_RECT(Int16 left, Int16 top, Int16 right, Int16 bottom)
            {
                Left = left;
                Top = top;
                Right = right;
                    ...
                    if (argument.Length > 0)
                    {
                        switch (argument[0])
                        {
                            ...
                            case '/':
                                ...
                                break;
                            // Removed from original class, as we will not use this functionality. 05.30.2006 - CLS
                            //							case '@':
